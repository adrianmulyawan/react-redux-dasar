      ...
      <div className="card p-3">
        <form onSubmit={ handleInputContact }>
          <div className="mb-3">
            ...
            <input type="text" className="form-control" id="name" name='name' onChange={ (e) => setName(e.target.value) } value={ name } required />
          </div>
          <div className="mb-3">
          ...
          <div className="mb-3">
            ...
            <input type="text" className="form-control" id="phoneNumber" name='phoneNumber' onChange={ (e) => setPhoneNumber(e.target.value) } value={ phoneNumber } required />
          </div>
